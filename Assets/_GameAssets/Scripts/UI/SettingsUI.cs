...
public class SettingsUI : MonoBehaviour
{
    ...
    [SerializeField] private bool _isMusicActive = true;
    [SerializeField] private bool _isSoundActive = true;
    ...
    private void Awake()
    {
        ...
        _musicButton.onClick.AddListener(OnMusicButonClicked);
        _soundButton.onClick.AddListener(OnSoundButonClicked);
    }

    private void OnMusicButonClicked()
    {
    ...
    private void OnSoundButonClicked()
    {
        AudioManager.Instance.Play(SoundType.ButtonClickSound);
